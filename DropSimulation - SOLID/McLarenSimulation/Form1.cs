...
namespace McLarenSimulation
{
    public partial class Form1 : Form
    {
       ...
       // Simulate buttom clicked
        ...
        {
            IConfiguration _configuration = new SphereDrop();
            double drag = -1;
            double fDensity = -1;
            double cRadius = -1;
            double cMass = -1;
            ...
            _configuration.Drag = drag;
            _configuration.FDensity = fDensity;
            _configuration.CRadius = cRadius;
            _configuration.CMass = cMass;
            _configuration.GAccel = gAccel;
            _configuration.GConst = gConst;
            _configuration.PMass = pMass;
            _configuration.PRadius = pRadius;
            _configuration.Height = height;
            _configuration.Velocity = velocity;
            _configuration.FinishTime = time;
            _configuration.TimeStep = step;
            _configuration.Force = NewtonianCheck.Checked ? Operations.NewtonianWeight(Result.Height) : -Operations.ConstGravityWeight(); // Calculate force of sphere depending on simulation type.
        }
